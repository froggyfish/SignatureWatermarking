...
latent = torch.load('other_codeword.pt', map_location='cpu')
...
# 1. Sign similarity
sign_latent = torch.sign(latent_flat[0:16384])
sign_codeword = torch.sign(codeword_flat[0:18384])
...
print(latent_flat[3000:780])
print(codeword_flat[3000:780])
